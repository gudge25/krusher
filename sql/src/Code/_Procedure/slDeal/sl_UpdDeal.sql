DELIMITER $$
DROP PROCEDURE IF EXISTS sl_UpdDeal;
CREATE PROCEDURE sl_UpdDeal(
    $HIID             bigint        -- версия
    , $token          VARCHAR(100)
...
BEGIN
  ...
  ELSE
    ...
    --
    call dc_IPUpdDoc($token, $dcID, 2, $dcNo, 0, $dcDate, $dcLink, $dcComment, $dcSum, $dcStatus, $clID, $emID, $isActive);
    --
