...
class ccCommentListModel extends BaseDAO {
    constructor() {
        const storedProc = {
            Find  : 'cc_GetCommentList',
            Insert: 'cc_InsCommentList',
            Update: 'cc_UpdCommentList',
            Delete: 'cc_DelCommentList'
        };
        super(storedProc);
...
const model = new ccCommentListModel();
