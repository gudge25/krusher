...
const model = require('./astCustomDestinationModel');
const schema = require('./astCustomDestinationSchema');
const ReplyHelper = require('src/base/reply-helper');

function astCustomDestinationHandler() {
...
const handler = new astCustomDestinationHandler();
