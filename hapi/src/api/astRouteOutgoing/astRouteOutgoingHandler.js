...
const model = require('./astRouteOutgoingModel');
const schema = require('./astRouteOutgoingSchema');
const ReplyHelper = require('src/base/reply-helper');

function astRouteOutgoingHandler() {
...
const handler = new astRouteOutgoingHandler();
