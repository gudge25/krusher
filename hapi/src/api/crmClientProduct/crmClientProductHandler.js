...
const model = require('./crmClientProductModel');
const schema = require('./crmClientProductSchema');
const ReplyHelper = require('src/base/reply-helper');

function crmClientProductHandler() {
...
const handler = new crmClientProductHandler();
