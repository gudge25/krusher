...
class ccCommentModel extends BaseDAO {
    constructor() {
        const storedProc = {
            Find:   'cc_GetComment',
            Insert: 'cc_InsComment',
            Update: 'cc_UpdComment',
            Delete: 'cc_DelComment'
        };
        super(storedProc);
...
class FindPost extends Model.Get {
    constructor(p) {
        ...
        d.cccID                         = p.cccID                           ? p.cccID                   : null;
        d.dcID                          = p.dcID                            ? p.dcID                    : null;
        d.comID                         = p.comID                           ? p.comID                   : null;
        d.comName                       = p.comName                         ? p.comName                 : null;
...
const model = new ccCommentModel();
