...
const model = require('./astRouteOutgoingItemsModel');
const schema = require('./astRouteOutgoingItemsSchema');
const ReplyHelper = require('src/base/reply-helper');

function astRouteOutgoingItemsHandler() {
...
const handler = new astRouteOutgoingItemsHandler();
