...
const model = require('./mpIntegrationInstallModel');
const schema = require('./mpIntegrationInstallSchema');
const ReplyHelper = require('src/base/reply-helper');

function mpIntegrationInstallHandler() {
...
const handler = new mpIntegrationInstallHandler();
