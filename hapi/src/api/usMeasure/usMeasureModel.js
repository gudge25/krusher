...
class usMeasureModel extends BaseDAO {
    constructor() {
        const storedProc = {
            Find : 'us_GetMeasure',
            Insert: 'us_InsMeasure',
            Update: 'us_UpdMeasure',
            Delete: 'us_DelMeasure',
        };
        super(storedProc);
...
class Update extends Model.Put {
    constructor(p) {
        ...
        const d = this.Data;
        d.msID = p.msID;
        d.msName = p.msName ? p.msName : null;
    }
}

const model = new usMeasureModel();
