...
const model = require('./astRouteIncomingModel');
const schema = require('./astRouteIncomingSchema');
const ReplyHelper = require('src/base/reply-helper');

function astRouteIncomingHandler() {
...
const handler = new astRouteIncomingHandler();
