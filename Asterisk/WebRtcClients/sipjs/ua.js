...
var config = {
  ...
  register			: true,
  displayName		: "10001",
  uri				: "10001@77.91.132.6",
  authorizationUser	: "10001",
  password			: "password",
  wsServers			: "ws://77.91.132.6:8088/ws",
  ...
  registrarServer	: 'sip:77.91.132.6',
  stunServers		: null,
  userAgentString	: "Zhdanov App"
};
...
function CreateUA(){ 
  ...
  //REGISTER UA
  if (ua.isRegistered()) ua.unregister(); else ua.register();
}
CreateUA()
...
function inviteSubmit(e) {
  ...
  var uri = elements.uaURI.value + "@77.91.132.6:8088";
